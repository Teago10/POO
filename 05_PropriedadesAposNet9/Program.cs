...
namespace _05_PropriedadesAposNet9
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            conta.Nome = "Thiago Silva" ; //Utilizando metodo acessador
            ...
            conta.Saldo = 1000.00m; // menbro publico (propriedade) - Atribuição de valor
        ...
        public class Conta
        {
            ...
            public decimal Saldo
            {
                get { return saldo; }//retorna o valor do campo saldo
                set
                {
                    this.Depositar(value); //value é uma palavra reservada que representa o valor que está sendo atribuído a propriedade
                }
            }
